...
from student import views as stview
...
path('generate-monitoring-report/<int:course_id>/', views.teacher_generate_exam_monitoring_pdf, name='teacher_monitoring_report'),
